# ✈️ Airline Twitter Sentiment Analysis
...
1. CrowdFlower. *Airline Twitter Sentiment Dataset*.  
...
5. Hutto, C. J., & Gilbert, E. (2014).  
   VADER: A Parsimonious Rule-based Model for Sentiment Analysis of Social Media Text. *ICWSM*.
